    ...
    return (
      <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6 h-full">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-gray-400">Select a repository to view files</p>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6 h-full flex flex-col">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="bg-green-500/20 px-3 py-1 rounded-full">
          <span className="text-green-300 text-sm font-medium">{files.length}</span>
        </div>
      </div>
      ...
      <div className="space-y-3 mb-4">
        <input
          ...
          className="w-full bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-white placeholder-gray-400 focus:outline-none focus:border-blue-500/50 focus:bg-white/15"
        />
